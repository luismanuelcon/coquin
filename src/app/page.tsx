  ...
  return (
    <AppChrome>
      <div className="page-stack">
        <section className="rounded-[30px] border border-[rgb(0_242_255_/_42%)] bg-[image:var(--gradient-primary)] p-5 text-white shadow-[var(--shadow-active)]">
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="text-xs font-bold uppercase opacity-80">Resumen de hoy</p>
              <h2 className="mt-2 text-[30px] font-extrabold leading-9">3 citas, 5 pendientes</h2>
            </div>
          ...
          <p className="mt-4 text-sm font-medium leading-6 text-white/82">
            Lo importante esta arriba: agenda, pagos, mercado y tareas urgentes para mantener la casa al dia.
          </p>
          <div className="mt-5 grid grid-cols-2 gap-3">
            <button className="rounded-full bg-white px-4 py-3 text-sm font-extrabold text-[#00363a]">
              Agregar cita
            </button>
            <button className="rounded-full border border-white/24 bg-white/10 px-4 py-3 text-sm font-extrabold text-white">
              Ver semana
            </button>
          </div>
        </section>
